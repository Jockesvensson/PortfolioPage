<template>
    <div class="l-constrained">
        <div id="portfolio-wrapper">
            ...
            <div id="product-item-portfolio" class="product-item" v-for="(item, index) in items" :key="index">
                <li>
                <div id="test" class="product-item__img" @mouseover="showItemIndex = index" @mouseleave="showItemIndex = null">
